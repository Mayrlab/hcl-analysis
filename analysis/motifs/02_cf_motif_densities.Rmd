...
# Plots
## All Sites (`r length(gr_cleavage)` sites)
...
## Single-UTR Genes (`r length(gr_single)` sites)
...
## Intronic Cleavage Sites (`r length(gr_ipa)` sites)
...
## Tandem Cleavage Sites (`r length(gr_multi_tandem)` sites)
...
#### Export
```{r export_gencode_only_rd}
ggsave("img/sq/fig1c-cleavage-factor-motifs.gencode-only.rel-density.pdf", width=8, height=6, dpi=300)
```

```{r plot_ctnone_gc_ns, fig.width=8, fig.height=6, warning=FALSE}
seqs <- getSeq(BSgenome.Hsapiens.UCSC.hg38, gr_ctnone_gc)
...
#### Export
```{r export_gencode_only_d}
ggsave("img/sq/fig1c-cleavage-factor-motifs.gencode-only.density.pdf", width=8, height=6, dpi=300)
```


```{r plot_ctnone_gc_count, fig.width=8, fig.height=6, warning=FALSE}
seqs <- getSeq(BSgenome.Hsapiens.UCSC.hg38, gr_ctnone_gc)
...
#### Export
```{r export_gencode_only_count}
ggsave("img/sq/fig1c-cleavage-factor-motifs.gencode-only.count.pdf", width=8, height=6, dpi=300)
```
...
#### Export
```{r export_common_rd}
ggsave("img/sq/fig1c-cleavage-factor-motifs.gencode-hcl-common.rel-density.pdf", 
       width=8, height=6, dpi=300)
```

```{r plot_common_density, fig.width=8, fig.height=6, warning=FALSE}
seqs <- getSeq(BSgenome.Hsapiens.UCSC.hg38, gr_common)
...
#### Export
```{r export_common_d}
ggsave("img/sq/fig1c-cleavage-factor-motifs.gencode-hcl-common.density.pdf", 
       width=8, height=6, dpi=300)
```

```{r plot_common_count, fig.width=8, fig.height=6, warning=FALSE}
seqs <- getSeq(BSgenome.Hsapiens.UCSC.hg38, gr_common)
...
#### Export
```{r export_common_count}
ggsave("img/sq/fig1c-cleavage-factor-motifs.gencode-hcl-common.count.pdf", 
       width=8, height=6, dpi=300)
```
...
```{r plot_novel_rd, fig.width=8, fig.height=6, warning=FALSE}
...
#### Export
```{r export_novel_only_rd}
ggsave("img/sq/fig1c-cleavage-factor-motifs.hcl-only.rel-density.pdf", 
       width=8, height=6, dpi=300)
```

```{r plot_novel_d, fig.width=8, fig.height=6, warning=FALSE}
seqs <- getSeq(BSgenome.Hsapiens.UCSC.hg38, gr_novel)
...
#### Export
```{r export_novel_only_d}
ggsave("img/sq/fig1c-cleavage-factor-motifs.hcl-only.density.pdf", 
       width=8, height=6, dpi=300)
```

```{r plot_novel_count, fig.width=8, fig.height=6, warning=FALSE}
seqs <- getSeq(BSgenome.Hsapiens.UCSC.hg38, gr_novel)
...
#### Export
```{r export_novel_only_count}
ggsave("img/sq/fig1c-cleavage-factor-motifs.hcl-only.count.pdf", 
       width=8, height=6, dpi=300)
```
...
#### Export
```{r export_ip}
ggsave("img/cleavage_factor_motifs.ip_likely.pdf", width=8, height=6, dpi=300)
```
...
#### Export
```{r export_ip_pa}
ggsave("img/cleavage_factor_motifs.ip_likely_pa.pdf", width=8, height=6, dpi=300)
```
...
## All Sites (`r length(gr_cleavage)` sites)
```{r plot_all_extra, fig.width=8, fig.height=6, warning=FALSE}
seqs <- getSeq(BSgenome.Hsapiens.UCSC.hg38, gr_cleavage)
...
rbind(df_tgta, df_pas, df_tgtgt, df_caatta) %>%
  plot_motif_density(title="All", col_values=COLOR_VALS_EXTRA)
```


## Single-UTR Genes (`r length(gr_single)` sites)
```{r plot_single_extra, fig.width=8, fig.height=6, warning=FALSE}
seqs <- getSeq(BSgenome.Hsapiens.UCSC.hg38, gr_single)
...
## GENCODE Only
### Proximal Cleavage Sites (`r length(gr_proximal_gc)` sites)
```{r plot_proximal_gc_extra, fig.width=8, fig.height=6, warning=FALSE}
seqs <- getSeq(BSgenome.Hsapiens.UCSC.hg38, gr_proximal_gc)
...
### Non-Distal Cleavage Sites (`r length(gr_nondistal_gc)` sites)
```{r plot_nondistal_gc_extra, fig.width=8, fig.height=6, warning=FALSE}
seqs <- getSeq(BSgenome.Hsapiens.UCSC.hg38, gr_nondistal_gc)
...
### Distal Cleavage Sites (`r length(gr_distal_gc)` sites)
```{r plot_distal_gc_extra, fig.width=8, fig.height=6, warning=FALSE}
seqs <- getSeq(BSgenome.Hsapiens.UCSC.hg38, gr_distal_gc)
