...
read_merges <- function (epsilon, tpm) {
    ipa_file <- sprintf("data/gff/utrome.e%s.t%s.gc39.pas3.f0.9999.w500.ipa.tsv",
                        epsilon, tpm)
    merge_file <- sprintf("data/gff/utrome.e%s.t%s.gc39.pas3.f0.9999.w500.m200.tsv",
                          epsilon, tpm)
...
df_merges <- tibble(epsilon=rep(c(10,15,20), 3),
       tpm=rep(c(1,3,5), each=3)) %>%
