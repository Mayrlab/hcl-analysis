...
Visualization of cleavage site coverage of mapped reads from the Human Cell
Landscape dataset.
...
```{r plot_rank_cov, fig.width=8, fig.height=20}
...
Slight decreases in site counts as merging distance is increased is consistent with
the idea that it eliminates local heterogeneity of sites. Generally, there is a 
balance of positive and negative strand site calls. However, there are a few sites 
in the negative strand that have extremely high read counts. Among these are some
PGA genes that are highly expressed in stomach.
